...
export default function SignInButton() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="text-white bg-black px-4 py-2 sm:px-6 sm:py-2.5 rounded-lg text-[15px] sm:text-[17px] font-medium sm:font-normal hover:bg-gray-800 transition-colors flex items-center gap-1"
      >
        Sign in
