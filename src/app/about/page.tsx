...
export default function AboutPage() {
  return (
    <main className={`${lexendDeca.className} min-h-screen bg-white text-black pt-32 pb-20`}>
      <div className="px-3 sm:px-36 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="mb-16">
            <h1 className="text-4xl sm:text-5xl font-light mb-6 text-black">About DeedBlock</h1>
          ...
          <motion.section
            ...
            className="mb-16"
          >
            <h2 className="text-3xl font-light text-black mb-8">Key Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="bg-white border border-gray-200 rounded-lg p-6 hover:border-black transition-colors shadow-sm"
                >
                  <feature.icon className="text-black mb-4" size={32} />
                  <h3 className="text-xl font-light text-black mb-2">{feature.title}</h3>
          ...
          <motion.section
            ...
            className="mb-16"
          >
            <h2 className="text-3xl font-light text-black mb-8">How It Works</h2>
            <div className="space-y-6">
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-light text-black mb-2">Property Registration</h3>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-light text-black mb-2">Blockchain Recording</h3>
                  <p className="text-gray-600 leading-relaxed">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-light text-black mb-2">Verification & Search</h3>
                  <p className="text-gray-600 leading-relaxed">
          ...
          <motion.section
            ...
            className="mb-16"
          >
            <h2 className="text-3xl font-light text-black mb-6">Technology</h2>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-8">
          ...
          >
            <h3 className="text-2xl font-light text-black mb-4">Ready to Get Started?</h3>
            <p className="text-gray-600 mb-6">Join us in revolutionizing Indian land and real estate transactions</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/search"
                className="px-8 py-3 bg-white border border-gray-200 text-black rounded-lg font-medium hover:bg-gray-50 transition-colors"
              >
                Search Properties
              </Link>
            </div>
